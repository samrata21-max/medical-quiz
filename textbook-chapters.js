...
chapterStyle.textContent = ".chapterPicker{position:relative}.chapterDropdownToggle{width:100%;height:42px;border:1px solid var(--border);border-radius:4px;background:#fff;color:var(--soft);font:14px var(--sans);padding:0 12px;display:flex;align-items:center;justify-content:space-between;gap:10px;cursor:pointer;text-align:left}.chapterDropdownToggle:hover{border-color:var(--accent)}.chapterDropdownToggle.open{border-color:var(--accent);box-shadow:0 0 0 2px var(--accent-soft)}.chapterDropdownLabel{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.chapterDropdownLabel.hasSelection{color:var(--ink);font-weight:500}.chapterDropdownCaret{flex:0 0 auto;color:var(--soft);font-size:11px;transition:transform .15s ease}.chapterDropdownToggle.open .chapterDropdownCaret{transform:rotate(180deg)}.chapterDropdownPanel{position:absolute;left:0;right:0;top:calc(100% + 6px);z-index:20;background:#fff;border:1px solid var(--border);border-radius:4px;box-shadow:0 10px 26px rgba(32,43,47,.14);padding:8px}.chapterDropdownPanel[hidden]{display:none}.chapterSearch{width:100%;height:38px;border:1px solid var(--border);border-radius:4px;padding:0 10px;background:#fff;color:var(--ink);font:14px var(--sans);margin-bottom:8px}.chapterSearch:focus{outline:2px solid var(--accent-soft);border-color:var(--accent)}.chapterOptions{display:grid;gap:6px;max-height:320px;overflow:auto;padding:2px}.chapterOption{display:flex;align-items:center;gap:8px;border:1px solid var(--border);border-radius:4px;padding:10px 12px;background:#fff;color:var(--ink);text-align:left;font:13px var(--sans);cursor:pointer}.chapterOption:hover{border-color:var(--accent);background:var(--accent-soft)}.chapterOption.selected{border-color:var(--accent);background:var(--accent-soft);color:var(--accent);font-weight:500}.chapterOption .chapterCheck{flex:0 0 14px;width:14px;text-align:center}.chapterSection{padding:10px 4px 4px;color:var(--accent);font:600 13px var(--serif)}.chapterEmpty{padding:16px;text-align:center;color:var(--soft);font-size:13px}";
